...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("isaacsim_rviz_training"), "models", "urdf", URDF_FILE]),
        ]
    )
    ...
    controller_params_file = os.path.join(get_package_share_directory(PKG_NAME),'config',PARAM_FILE)
